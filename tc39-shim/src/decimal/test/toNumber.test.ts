...
import {decimal, DECIMAL_BASE, decimal_toNumber, type DecimalAble, setDefaultNegativeExponent, setDefaultPositiveExponent, setStrictMode} from "../decimal.ts";
import {areEqual, endCheck, isException, isTrue} from "./test-helper.ts";
declare global {

...
Deno.test('cmp, eq, gt, gte, lt, lte', function () {
  ...
  function t(a:DecimalAble, b:DecimalAble, expected:number) {
    areEqual(String(expected), String(decimal_cmp(decimal(a),b)));

    if (expected === 1) {
      isTrue(decimal_gt(decimal(a),b));
      isTrue(decimal_gte(decimal(a),b));
      isTrue(!decimal_eq(decimal(a),b));
      isTrue(!decimal_lt(decimal(a),b));
      isTrue(!decimal_lte(decimal(a),b));
    } else if (expected === -1) {
      isTrue(decimal_lt(decimal(a),b));
      isTrue(decimal_lte(decimal(a),b));
      isTrue(!decimal_eq(decimal(a),b));
  ...
  let n = decimal(1);
  isTrue(decimal_eq(n,n));
  isTrue(decimal_eq(n,1));
  isTrue(decimal_eq(n,'1.0'));
  isTrue(decimal_eq(n,'1.000000'));
  isTrue(decimal_eq(n,decimal(1)));
  isTrue(decimal_gt(n,0.99999));
  isTrue(!decimal_gte(n,1.1));
  isTrue(decimal_lt(n,1.001));
  isTrue(decimal_lte(n,2));

  n = decimal('-0.1');
  isTrue(!decimal_eq(n,0.1));
  isTrue(!decimal_gt(n,-0.1));
  isTrue(decimal_gte(n,-1));
  isTrue(decimal_lt(n,-0.01));
  isTrue(!decimal_lte(n,-1));

  n = decimal('0.0000000');
  isTrue(decimal_eq(n,-0));
  isTrue(decimal_gt(n,-0.000001));
  isTrue(!decimal_gte(n,0.1));
  isTrue(decimal_lt(n,0.0001));
  isTrue(decimal_lte(n,-0));

  n = decimal(-0);
  isTrue(decimal_eq(n,'0.000'));
  isTrue(decimal_gt(n,-1));
  isTrue(!decimal_gte(n,0.1));
  isTrue(!decimal_lt(n,0));
  isTrue(decimal_lt(n,0.1));
  isTrue(decimal_lte(n,0));

  n = decimal('-1.234e+2');
  isTrue(decimal_eq(n,-123.4));
  isTrue(decimal_gte(n,'-1.234e+3'));
  isTrue(decimal_lt(n,-123.39999));
  isTrue(decimal_lte(n,'-123.4e+0'));

  n = decimal('5e-200');
  isTrue(decimal_eq(n,5e-200));
  isTrue(decimal_gt(n,5e-201));
  isTrue(!decimal_gte(n,1));
  isTrue(decimal_lt(n,6e-200));
  isTrue(decimal_lte(n,5.1e-200));

  n = decimal('1');
  isTrue(decimal_eq(n,n));
  isTrue(decimal_eq(n,decimal_toString(n,)));
  isTrue(decimal_eq(n,decimal_valueOf(n,)));
  isTrue(decimal_eq(n,decimal_toFixed(n,)));
  isTrue(decimal_eq(n,1));
  isTrue(decimal_eq(n,'1e+0'));
  isTrue(!decimal_eq(n,-1));
  isTrue(!decimal_eq(n,0.1));

  isTrue(!decimal_eq(decimal(0.1),0));
  isTrue(!decimal_eq(decimal(1e9 + 1),1e9));
  isTrue(!decimal_eq(decimal(1e9 - 1),1e9));
  isTrue(decimal_eq(decimal(1e9 + 1),1e9 + 1));
  isTrue(decimal_eq(decimal(1),1));
  isTrue(!decimal_eq(decimal(1),-1));

  isTrue(!decimal_lt(decimal(1.23001e-2),1.23e-2));
  isTrue(decimal_lt(decimal(1.23e-2),1.23001e-2));
  isTrue(!decimal_lt(decimal(1e-2),9.999999e-3));
  isTrue(decimal_lt(decimal(9.999999e-3),1e-2));
  isTrue(!decimal_lt(decimal(1.23001e+2),1.23e+2));
  isTrue(decimal_lt(decimal(1.23e+2),1.23001e+2));
  isTrue(decimal_lt(decimal(9.999999e+2),1e+3));
  isTrue(!decimal_lt(decimal(1e+3),9.9999999e+2));

  isTrue(!decimal_lte(decimal(1.23001e-2),1.23e-2));
  isTrue(decimal_lte(decimal(1.23e-2),1.23001e-2));
  isTrue(!decimal_lte(decimal(1e-2),9.999999e-3));
  isTrue(decimal_lte(decimal(9.999999e-3),1e-2));

  isTrue(!decimal_lte(decimal(1.23001e+2),1.23e+2));
  isTrue(decimal_lte(decimal(1.23e+2),1.23001e+2));
  isTrue(decimal_lte(decimal(9.999999e+2),1e+3));
  isTrue(!decimal_lte(decimal(1e+3),9.9999999e+2));

  isTrue(decimal_gt(decimal(1.23001e-2),1.23e-2));
  isTrue(!decimal_gt(decimal(1.23e-2),1.23001e-2));
  isTrue(decimal_gt(decimal(1e-2),9.999999e-3));
  isTrue(!decimal_gt(decimal(9.999999e-3),1e-2));

  isTrue(decimal_gt(decimal(1.23001e+2),1.23e+2));
  isTrue(!decimal_gt(decimal(1.23e+2),1.23001e+2));
  isTrue(!decimal_gt(decimal(9.999999e+2),1e+3));
  isTrue(decimal_gt(decimal(1e+3),9.9999999e+2));

  isTrue(decimal_gte(decimal(1.23001e-2),1.23e-2));
  isTrue(!decimal_gte(decimal(1.23e-2),1.23001e-2));
  isTrue(decimal_gte(decimal(1e-2),9.999999e-3));
  isTrue(!decimal_gte(decimal(9.999999e-3),1e-2));

  isTrue(decimal_gte(decimal(1.23001e+2),1.23e+2));
  isTrue(!decimal_gte(decimal(1.23e+2),1.23001e+2));
  isTrue(!decimal_gte(decimal(9.999999e+2),1e+3));
  isTrue(decimal_gte(decimal(1e+3),9.9999999e+2));
  ...
  isException(function () {decimal_eq(decimal('12.345'),undefined as any)}, ".eq(undefined)");
  isException(function () {decimal_eq(decimal('12.345'),null as any)}, ".eq(null)");
  isException(function () {decimal_eq(decimal('12.345'),NaN)}, ".eq(NaN)");
  isException(function () {decimal_eq(decimal('12.345'),'NaN')}, ".eq('NaN')");
  isException(function () {decimal_eq(decimal('12.345'),[] as any)}, ".eq([])");
  isException(function () {decimal_eq(decimal('12.345'),{} as any)}, ".eq({})");
  isException(function () {decimal_eq(decimal('12.345'),'')}, ".eq('')");
  isException(function () {decimal_eq(decimal('12.345'),' ')}, ".eq(' ')");
  isException(function () {decimal_eq(decimal('12.345'),'hello')}, ".eq('hello')");
  isException(function () {decimal_eq(decimal('12.345'),'\t')}, ".eq('\t')");
  isException(function () {decimal_eq(decimal('12.345'),new Date as any)}, ".eq(new Date)");
  isException(function () {decimal_eq(decimal('12.345'),new RegExp('') as any)}, ".eq(new RegExp(''))");
  isException(function () {decimal_eq(decimal('12.345'),function () {} as any)}, ".eq(function () {})");
  isException(function () {decimal_eq(decimal('12.345'),' 0.1')}, ".eq(' 0.1')");
  isException(function () {decimal_eq(decimal('12.345'),'7.5 ')}, ".eq('7.5 ')");
  isException(function () {decimal_eq(decimal('12.345'),' 0 ')}, ".eq(' 0 ')");
  isException(function () {decimal_eq(decimal('12.345'),'+1')}, ".eq('+1')");
  isException(function () {decimal_eq(decimal('12.345'),' +1.2')}, ".eq(' +1.2')");
  isException(function () {decimal_eq(decimal('12.345'),'- 99')}, ".eq('- 99')");
  isException(function () {decimal_eq(decimal('12.345'),'9.9.9')}, ".eq('9.9.9')");
  isException(function () {decimal_eq(decimal('12.345'),'10.1.0')}, ".eq('10.1.0')");
  isException(function () {decimal_eq(decimal('12.345'),'0x16')}, ".eq('0x16')");
  isException(function () {decimal_eq(decimal('12.345'),'1e')}, ".eq('1e')");
  isException(function () {decimal_eq(decimal('12.345'),'8 e')}, ".eq('8 e')");
  isException(function () {decimal_eq(decimal('12.345'),'77-e')}, ".eq('77-e')");
  isException(function () {decimal_eq(decimal('12.345'),'123e.0')}, ".eq('123e.0')");
  isException(function () {decimal_eq(decimal('12.345'),'4e1.')}, ".eq('4e1.')");
  isException(function () {decimal_eq(decimal('12.345'),Infinity)}, ".eq(Infinity)");
  isException(function () {decimal_eq(decimal('12.345'),'-Infinity')}, ".eq('-Infinity')");

  isException(function () {decimal_gt(decimal('0'),undefined as any)}, ".gt(undefined)");
  isException(function () {decimal_gt(decimal('0'),null as any)}, ".gt(null)");
  isException(function () {decimal_gt(decimal('0'),NaN)}, ".gt(NaN)");
  isException(function () {decimal_gt(decimal('0'),'NaN')}, ".gt('NaN')");
  isException(function () {decimal_gt(decimal('0'),[] as any)}, ".gt([])");
  isException(function () {decimal_gt(decimal('0'),{} as any)}, ".gt({})");
  isException(function () {decimal_gt(decimal('0'),'')}, ".gt('')");
  isException(function () {decimal_gt(decimal('0'),' ')}, ".gt(' ')");
  isException(function () {decimal_gt(decimal('0'),'hello')}, ".gt('hello')");
  isException(function () {decimal_gt(decimal('0'),'\t')}, ".gt('\t')");
  isException(function () {decimal_gt(decimal('0'),new Date as any)}, ".gt(new Date)");
  isException(function () {decimal_gt(decimal('0'),new RegExp('') as any)}, ".gt(new RegExp(''))");
  isException(function () {decimal_gt(decimal('0'),function () {} as any)}, ".gt(function () {})");
  isException(function () {decimal_gt(decimal('0'),' 0.1')}, ".gt(' 0.1')");
  isException(function () {decimal_gt(decimal('0'),'7.5 ')}, ".gt('7.5 ')");
  isException(function () {decimal_gt(decimal('0'),' 0 ')}, ".gt(' 0 ')");
  isException(function () {decimal_gt(decimal('0'),'+1')}, ".gt('+1')");
  isException(function () {decimal_gt(decimal('0'),' +1.2')}, ".gt(' +1.2')");
  isException(function () {decimal_gt(decimal('0'),'- 99')}, ".gt('- 99')");
  isException(function () {decimal_gt(decimal('0'),'9.9.9')}, ".gt('9.9.9')");
  isException(function () {decimal_gt(decimal('0'),'10.1.0')}, ".gt('10.1.0')");
  isException(function () {decimal_gt(decimal('0'),'0x16')}, ".gt('0x16')");
  isException(function () {decimal_gt(decimal('0'),'1e')}, ".gt('1e')");
  isException(function () {decimal_gt(decimal('0'),'8 e')}, ".gt('8 e')");
  isException(function () {decimal_gt(decimal('0'),'77-e')}, ".gt('77-e')");
  isException(function () {decimal_gt(decimal('0'),'123e.0')}, ".gt('123e.0')");
  isException(function () {decimal_gt(decimal('0'),'4e1.')}, ".gt('4e1.')");
  isException(function () {decimal_gt(decimal('0'),Infinity)}, ".gt(Infinity)");
  isException(function () {decimal_gt(decimal('0'),'-Infinity')}, ".gt('-Infinity')");

  isException(function () {decimal_gte(decimal('9.9900E2'),undefined as any)}, ".gte(undefined)");
  isException(function () {decimal_gte(decimal('9.9900E2'),null as any)}, ".gte(null)");
  isException(function () {decimal_gte(decimal('9.9900E2'),NaN)}, ".gte(NaN)");
  isException(function () {decimal_gte(decimal('9.9900E2'),'NaN')}, ".gte('NaN')");
  isException(function () {decimal_gte(decimal('9.9900E2'),[] as any)}, ".gte([])");
  isException(function () {decimal_gte(decimal('9.9900E2'),{} as any)}, ".gte({})");
  isException(function () {decimal_gte(decimal('9.9900E2'),'')}, ".gte('')");
  isException(function () {decimal_gte(decimal('9.9900E2'),' ')}, ".gte(' ')");
  isException(function () {decimal_gte(decimal('9.9900E2'),'hello')}, ".gte('hello')");
  isException(function () {decimal_gte(decimal('9.9900E2'),'\t')}, ".gte('\t')");
  isException(function () {decimal_gte(decimal('9.9900E2'),new Date as any)}, ".gte(new Date)");
  isException(function () {decimal_gte(decimal('9.9900E2'),new RegExp('') as any)},  ".gte(new RegExp(''))");
  isException(function () {decimal_gte(decimal('9.9900E2'),function () {} as any)}, ".gte(function () {})");
  isException(function () {decimal_gte(decimal('9.9900E2'),' 0.1')}, ".gte(' 0.1')");
  isException(function () {decimal_gte(decimal('9.9900E2'),'7.5 ')}, ".gte('7.5 ')");
  isException(function () {decimal_gte(decimal('9.9900E2'),' 0 ')}, ".gte(' 0 ')");
  isException(function () {decimal_gte(decimal('9.9900E2'),'+1')}, ".gte('+1')");
  isException(function () {decimal_gte(decimal('9.9900E2'),' +1.2')}, ".gte(' +1.2')");
  isException(function () {decimal_gte(decimal('9.9900E2'),'- 99')}, ".gte('- 99')");
  isException(function () {decimal_gte(decimal('9.9900E2'),'9.9.9')}, ".gte('9.9.9')");
  isException(function () {decimal_gte(decimal('9.9900E2'),'10.1.0')}, ".gte('10.1.0')");
  isException(function () {decimal_gte(decimal('9.9900E2'),'0x16')}, ".gte('0x16')");
  isException(function () {decimal_gte(decimal('9.9900E2'),'1e')}, ".gte('1e')");
  isException(function () {decimal_gte(decimal('9.9900E2'),'8 e')}, ".gte('8 e')");
  isException(function () {decimal_gte(decimal('9.9900E2'),'77-e')}, ".gte('77-e')");
  isException(function () {decimal_gte(decimal('9.9900E2'),'123e.0')}, ".gte('123e.0')");
  isException(function () {decimal_gte(decimal('9.9900E2'),'4e1.')}, ".gte('4e1.')");
  isException(function () {decimal_gte(decimal('9.9900E2'),Infinity)}, ".gte(Infinity)");
  isException(function () {decimal_gte(decimal('9.9900E2'),'-Infinity')}, ".gte('-Infinity')");

  isException(function () {decimal_lt(decimal('12.345'),undefined as any)}, ".lt(undefined)");
  isException(function () {decimal_lt(decimal('12.345'),null as any)}, ".lt(null)");
  isException(function () {decimal_lt(decimal('12.345'),NaN)}, ".lt(NaN)");
  isException(function () {decimal_lt(decimal('12.345'),'NaN')}, ".lt('NaN')");
  isException(function () {decimal_lt(decimal('12.345'),[] as any)}, ".lt([])");
  isException(function () {decimal_lt(decimal('12.345'),{} as any)}, ".lt({})");
  isException(function () {decimal_lt(decimal('12.345'),'')}, ".lt('')");
  isException(function () {decimal_lt(decimal('12.345'),' ')}, ".lt(' ')");
  isException(function () {decimal_lt(decimal('12.345'),'hello')}, ".lt('hello')");
  isException(function () {decimal_lt(decimal('12.345'),'\t')}, ".lt('\t')");
  isException(function () {decimal_lt(decimal('12.345'),new Date as any)}, ".lt(new Date)");
  isException(function () {decimal_lt(decimal('12.345'),new RegExp('') as any)}, ".lt(new RegExp(''))");
  isException(function () {decimal_lt(decimal('12.345'),function () {} as any)}, ".lt(function () {})");
  isException(function () {decimal_lt(decimal('12.345'),' 0.1')}, ".lt(' 0.1')");
  isException(function () {decimal_lt(decimal('12.345'),'7.5 ')}, ".lt('7.5 ')");
  isException(function () {decimal_lt(decimal('12.345'),' 0 ')}, ".lt(' 0 ')");
  isException(function () {decimal_lt(decimal('12.345'),'+1')}, ".lt('+1')");
  isException(function () {decimal_lt(decimal('12.345'),' +1.2')}, ".lt(' +1.2')");
  isException(function () {decimal_lt(decimal('12.345'),'- 99')}, ".lt('- 99')");
  isException(function () {decimal_lt(decimal('12.345'),'9.9.9')}, ".lt('9.9.9')");
  isException(function () {decimal_lt(decimal('12.345'),'10.1.0')}, ".lt('10.1.0')");
  isException(function () {decimal_lt(decimal('12.345'),'0x16')}, ".lt('0x16')");
  isException(function () {decimal_lt(decimal('12.345'),'1e')}, ".lt('1e')");
  isException(function () {decimal_lt(decimal('12.345'),'8 e')}, ".lt('8 e')");
  isException(function () {decimal_lt(decimal('12.345'),'77-e')}, ".lt('77-e')");
  isException(function () {decimal_lt(decimal('12.345'),'123e.0')}, ".lt('123e.0')");
  isException(function () {decimal_lt(decimal('12.345'),'4e1.')}, ".lt('4e1.')");
  isException(function () {decimal_lt(decimal('12.345'),Infinity)}, ".lt(Infinity)");
  isException(function () {decimal_lt(decimal('12.345'),'-Infinity')}, ".lt('-Infinity')");

  isException(function () {decimal_lte(decimal('12.345'),undefined as any)}, ".lte(undefined)");
  isException(function () {decimal_lte(decimal('12.345'),null as any)}, ".lte(null)");
  isException(function () {decimal_lte(decimal('12.345'),NaN)}, ".lte(NaN)");
  isException(function () {decimal_lte(decimal('12.345'),'NaN')}, ".lte('NaN')");
  isException(function () {decimal_lte(decimal('12.345'),[] as any)}, ".lte([])");
  isException(function () {decimal_lte(decimal('12.345'),{} as any)}, ".lte({})");
  isException(function () {decimal_lte(decimal('12.345'),'')}, ".lte('')");
  isException(function () {decimal_lte(decimal('12.345'),' ')}, ".lte(' ')");
  isException(function () {decimal_lte(decimal('12.345'),'hello')}, ".lte('hello')");
  isException(function () {decimal_lte(decimal('12.345'),'\t')}, ".lte('\t')");
  isException(function () {decimal_lte(decimal('12.345'),new Date as any)}, ".lte(new Date)");
  isException(function () {decimal_lte(decimal('12.345'),new RegExp('') as any)}, ".lte(new RegExp(''))");
  isException(function () {decimal_lte(decimal('12.345'),function () {} as any)}, ".lte(function () {})");
  isException(function () {decimal_lte(decimal('12.345'),' 0.1')}, ".lte(' 0.1')");
  isException(function () {decimal_lte(decimal('12.345'),'7.5 ')}, ".lte('7.5 ')");
  isException(function () {decimal_lte(decimal('12.345'),' 0 ')}, ".lte(' 0 ')");
  isException(function () {decimal_lte(decimal('12.345'),'+1')}, ".lte('+1')");
  isException(function () {decimal_lte(decimal('12.345'),' +1.2')}, ".lte(' +1.2')");
  isException(function () {decimal_lte(decimal('12.345'),'- 99')}, ".lte('- 99')");
  isException(function () {decimal_lte(decimal('12.345'),'9.9.9')}, ".lte('9.9.9')");
  isException(function () {decimal_lte(decimal('12.345'),'10.1.0')}, ".lte('10.1.0')");
  isException(function () {decimal_lte(decimal('12.345'),'0x16')}, ".lte('0x16')");
  isException(function () {decimal_lte(decimal('12.345'),'1e')}, ".lte('1e')");
  isException(function () {decimal_lte(decimal('12.345'),'8 e')}, ".lte('8 e')");
  isException(function () {decimal_lte(decimal('12.345'),'77-e')}, ".lte('77-e')");
  isException(function () {decimal_lte(decimal('12.345'),'123e.0')}, ".lte('123e.0')");
  isException(function () {decimal_lte(decimal('12.345'),'4e1.')}, ".lte('4e1.')");
  isException(function () {decimal_lte(decimal('12.345'),Infinity)}, ".lte(Infinity)");
  isException(function () {decimal_lte(decimal('12.345'),'-Infinity')}, ".lte('-Infinity')");

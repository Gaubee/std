...
type PureEventDelegateWithApply<T> = PureEventDelegate<T> & PureEventDelegate<T>["watch"];
...
obj_delegate_by<PureEvent<any>, PureEventDelegate<any>>(PureEventDelegate.prototype, PureEvent.prototype, (target) => target.byPureEvent);
